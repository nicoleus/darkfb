#Decompiled by NICOLEUS.F.SITORUS
...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mSedang Masuk LAE \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def mini():
    ...
    try:
        ...
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Akun target harus berteman dengan akun anda dulu lAE!'
        try:
...
def pilih_lain():
    ...
    if other == '':
        print '\x1b[1;91m[!] Jangan kosong LAE'
        pilih_lain()
    else:
        if other == '1':
            status()
